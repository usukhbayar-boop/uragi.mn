                                                        ...
                                                        <div className="atropos-scale">
                                                            <div className="atropos-rotate">
                                                                <div className="atropos-inner overflow-visible d-flex justify-end">
                                                                    <img data-atropos-offset={0} className="shapes-2-img-1 initial-img" src="/img/home-2/images/1.png" alt="image" />
                                                                    <img data-atropos-offset={5} className="shapes-2-img-2 shadow-card z-2" src="/img/home-2/images/2.png" alt="image" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="shapes-2 relative">
                                                    <div className="atropos -no-shadow js-atropos">
                                                        <div className="atropos-scale">
                                                            <div className="atropos-rotate">
                                                                <div className="atropos-inner overflow-visible d-flex justify-end">
                                                                    <img data-atropos-offset={0} className="shapes-2-img-1 initial-img" src="/img/home-7/tabs/1.png" alt="image" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="shapes-2 relative">
                                                    <div className="atropos -no-shadow js-atropos">
                                                        <div className="atropos-scale">
                                                            <div className="atropos-rotate">
                                                                <div className="atropos-inner overflow-visible d-flex justify-end">
                                                                    <img data-atropos-offset={0} className="shapes-2-img-1 initial-img" src="/img/home-7/tabs/2.png" alt="image" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
