                ...
                <div className="container">
                    ...
                    <div className="row y-gap-32 pt-60 sm:pt-40">
                        <div className="col-xl-3 col-lg-3 col-sm-6">
                            <div>
                                <div className="ratio ratio-27:33 rounded-8">
                                    <img className="absolute-full-center object-fit-cover rounded-8" src="/img/team/1.jpg" alt="Image" />
                                </div>
                                <div className="mt-20">
                        ...
                        <div className="col-xl-3 col-lg-3 col-sm-6">
                            <div>
                                <div className="ratio ratio-27:33 rounded-8">
                                    <img className="absolute-full-center object-fit-cover rounded-8" src="/img/team/2.jpg" alt="Image" />
                                </div>
                                <div className="mt-20">
                        ...
                        <div className="col-xl-3 col-lg-3 col-sm-6">
                            <div>
                                <div className="ratio ratio-27:33 rounded-8">
                                    <img className="absolute-full-center object-fit-cover rounded-8" src="/img/team/3.jpg" alt="Image" />
                                </div>
                                <div className="mt-20">
                        ...
                        <div className="col-xl-3 col-lg-3 col-sm-6">
                            <div>
                                <div className="ratio ratio-27:33 rounded-8">
                                    <img className="absolute-full-center object-fit-cover rounded-8" src="/img/team/4.jpg" alt="Image" />
                                </div>
                                <div className="mt-20">
