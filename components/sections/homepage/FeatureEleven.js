                        ...
                        <div className="col-xl-5 col-lg-6 col-md-8">
                            <div className="wow animate__animated animate__fadeIn">
                                <div className="d-flex justify-center items-center">
                                    <img className="initial-img" src="/img/home-10/images/1.png" alt="image" />
                                    <div className="atropos -no-shadow absolute z-2 js-atropos">
                                        <div className="atropos-scale">
                                            <div className="atropos-rotate">
                                                <div className="atropos-inner overflow-visible">
                                                    <img data-atropos-offset={0} className="max-w-100" src="/img/home-10/images/2.png" alt="image" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-xl-5 col-lg-6 col-md-8 order-lg-2 order-1">
                                <div className="tabs__content js-tabs-content">
                                    <div className={`tabs__pane -tab-item-1  ${active == 1 ? "is-active" : ""}`}>
                                        <div className="wow animate__animated animate__fadeIn">
                                            <div>
                                                <img className="js-rellax initial-img" src="/img/home-10/images/3.png" alt="image" />
                                            </div>
                                            <div className="absolute-center pt-60 col-11">
                                                <img className="js-rellax max-w-100 " src="/img/home-10/images/4.png" alt="image" />
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div className="atropos-scale">
                                                <div className="atropos-rotate">
                                                    <div className="atropos-inner overflow-visible d-flex justify-center items-center">
                                                        <img data-atropos-offset={0} className="initial-img relative z-1" src="/img/home-2/api/bg.png" alt="image" />
                                                        <div className="absolute-center z-2">
                                                            <img data-atropos-offset={5} className="max-w-100" src="/img/home-2/api/2.png" alt="image" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="atropos-scale">
                                                <div className="atropos-rotate">
                                                    <div className="atropos-inner overflow-visible d-flex justify-center items-center">
                                                        <img data-atropos-offset={0} className="initial-img relative z-1" src="/img/home-2/api/bg.png" alt="image" />
                                                        <div className="absolute-center z-2">
                                                            <img data-atropos-offset={5} className="max-w-100" src="/img/home-2/api/3.png" alt="image" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div className="container">
                    <div className="row y-gap-32 justify-between md:justify-center items-center">
                        <div className="col-xl-5 col-lg-6 col-md-8">
                            <div className="wow animate__animated animate__fadeIn">
                                <div className="d-flex justify-center items-center">
                                    <img className="initial-img" src="/img/home-10/images/5.png" alt="image" />
                                    <div className="atropos -no-shadow absolute z-2 js-atropos">
                                        <div className="atropos-scale">
                                            <div className="atropos-rotate">
                                                <div className="atropos-inner overflow-visible">
                                                    <img data-atropos-offset={0} className="max-w-100" src="/img/home-10/images/6.png" alt="image" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
