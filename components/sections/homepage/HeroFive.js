                        ...
                        <div className="col-xl-7 col-lg-9 col-md-10">
                            <div className="masthead__content md:text-center relative z-2">
                                <div data-split="lines">
                                    ...
                                    {/* Digital age<br className="md:d-none" /> adventure in  */}
                                        <span className="text-accent">Ургийн бичиг</span>
                                    </h1>
                                </div>
                                <div data-split="lines">
                                    <p className="masthead__text pt-24">
                                        Ургийн бичигээ шинэлэг байдлаар, хүссэн загвар дээрээ хөтөлцгөөе<br className="sm:d-none" />
                                    </p>
                                </div>
                                <div className="masthead__buttons row y-gap-20 x-gap-24 md:justify-center items-center pt-40 sm:pt-24">
                                    <div className="col-auto">
                                        <Link href="/register" className="button -md -accent rounded-8 text-white">Бүртгүүлэх</Link>
                                    </div>
                                    <div className="col-auto">
