        ...
        <>
            ...
            <div className="works-row  masonry -col-3 -gap-32 pt-60 sm:pt-40 js-masonry js-masonry-no-filter">
                ...
                <div className="masonry__item e_commerce">
                    <div className="h:zoom ratio">
                        <div className="absolute-full-center hover-group overflow-hidden rounded-8">
                            <img className="object-fit-cover absolute-full-center z-1 h:zoom__item rounded-8" src="/img/portfolio/cards/1.jpg" alt="image" />
                ...
                <div className="masonry__item   e_commerce digital_design">
                    <div className="h:zoom ratio">
                        <div className="absolute-full-center hover-group overflow-hidden rounded-8">
                            <img className="object-fit-cover absolute-full-center z-1 h:zoom__item rounded-8" src="/img/portfolio/cards/2.jpg" alt="image" />
                            <div className="d-flex items-end px-48 py-48 lg:px-32 lg:py-32 sm:px-24 sm:py-24 gradient-content rounded-8 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                                <div className="absolute-center">
                                    <div className="d-flex justify-center items-center border-2-white rounded-full size-60">
                ...
                <div className="masonry__item   web_design digital_design branding">
                    <div className="h:zoom ratio">
                        <div className="absolute-full-center hover-group overflow-hidden rounded-8">
                            <img className="object-fit-cover absolute-full-center z-1 h:zoom__item rounded-8" src="/img/portfolio/cards/3.jpg" alt="image" />
                            <div className="d-flex items-end px-48 py-48 lg:px-32 lg:py-32 sm:px-24 sm:py-24 gradient-content rounded-8 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                                <div className="absolute-center">
                                    <div className="d-flex justify-center items-center border-2-white rounded-full size-60">
                ...
                <div className="masonry__item   e_commerce branding">
                    <div className="h:zoom ratio">
                        <div className="absolute-full-center hover-group overflow-hidden rounded-8">
                            <img className="object-fit-cover absolute-full-center z-1 h:zoom__item rounded-8" src="/img/portfolio/cards/8.jpg" alt="image" />
                            <div className="d-flex items-end px-48 py-48 lg:px-32 lg:py-32 sm:px-24 sm:py-24 gradient-content rounded-8 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                                <div className="absolute-center">
                                    <div className="d-flex justify-center items-center border-2-white rounded-full size-60">
                ...
                <div className="masonry__item -big  web_design digital_design branding">
                    <div className="h:zoom ratio">
                        <div className="absolute-full-center hover-group overflow-hidden rounded-8">
                            <img className="object-fit-cover absolute-full-center z-1 h:zoom__item rounded-8" src="/img/portfolio/cards/7.jpg" alt="image" />
                            <div className="d-flex items-end px-48 py-48 lg:px-32 lg:py-32 sm:px-24 sm:py-24 gradient-content rounded-8 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                                <div className="absolute-center">
                                    <div className="d-flex justify-center items-center border-2-white rounded-full size-60">
                ...
                <div className="masonry__item   e_commerce">
                    <div className="h:zoom ratio">
                        <div className="absolute-full-center hover-group overflow-hidden rounded-8">
                            <img className="object-fit-cover absolute-full-center z-1 h:zoom__item rounded-8" src="/img/portfolio/cards/9.jpg" alt="image" />
                            <div className="d-flex items-end px-48 py-48 lg:px-32 lg:py-32 sm:px-24 sm:py-24 gradient-content rounded-8 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                                <div className="absolute-center">
                                    <div className="d-flex justify-center items-center border-2-white rounded-full size-60">
                ...
                <div className="masonry__item   e_commerce digital_design">
                    <div className="h:zoom ratio">
                        <div className="absolute-full-center hover-group overflow-hidden rounded-8">
                            <img className="object-fit-cover absolute-full-center z-1 h:zoom__item rounded-8" src="/img/portfolio/cards/18.jpg" alt="image" />
                            <div className="d-flex items-end px-48 py-48 lg:px-32 lg:py-32 sm:px-24 sm:py-24 gradient-content rounded-8 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                                <div className="absolute-center">
                                    <div className="d-flex justify-center items-center border-2-white rounded-full size-60">
                ...
                <div className="masonry__item   digital_design web_design branding">
                    <div className="h:zoom ratio">
                        <div className="absolute-full-center hover-group overflow-hidden rounded-8">
                            <img className="object-fit-cover absolute-full-center z-1 h:zoom__item rounded-8" src="/img/portfolio/cards/20.jpg" alt="image" />
                            <div className="d-flex items-end px-48 py-48 lg:px-32 lg:py-32 sm:px-24 sm:py-24 gradient-content rounded-8 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                                <div className="absolute-center">
                                    <div className="d-flex justify-center items-center border-2-white rounded-full size-60">
