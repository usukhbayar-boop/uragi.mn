        ...
        <>
            ...
            <div className="works-row masonry -col-4 pt-60 sm:pt-40 js-masonry js-masonry-no-filter">
                ...
                <div className="masonry__item -no-ratio  e_commerce">
                    <div>
                        <div className="ratio ratio-48:50 hover-group">
                            <img className="absolute-full-center object-fit-cover z-1" src="/img/portfolio/cards/1.jpg" alt="image" />
                ...
                <div className="masonry__item -no-ratio  e_commerce digital_design">
                    <div>
                        <div className="ratio ratio-48:50 hover-group">
                            <img className="absolute-full-center object-fit-cover z-1" src="/img/portfolio/cards/2.jpg" alt="image" />
                            <div className="px-10 py-10 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="d-flex justify-center items-center w-1/1 h-1/1 relative">
                                    <div className="bg-white absolute-full-center" />
                                    <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                ...
                <div className="masonry__item -no-ratio  web_design digital_design branding">
                    <div>
                        <div className="ratio ratio-48:50 hover-group">
                            <img className="absolute-full-center object-fit-cover z-1" src="/img/portfolio/cards/3.jpg" alt="image" />
                            <div className="px-10 py-10 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="d-flex justify-center items-center w-1/1 h-1/1 relative">
                                    <div className="bg-white absolute-full-center" />
                                    <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                ...
                <div className="masonry__item -no-ratio  e_commerce branding">
                    <div>
                        <div className="ratio ratio-48:50 hover-group">
                            <img className="absolute-full-center object-fit-cover z-1" src="/img/portfolio/cards/10.jpg" alt="image" />
                            <div className="px-10 py-10 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="d-flex justify-center items-center w-1/1 h-1/1 relative">
                                    <div className="bg-white absolute-full-center" />
                                    <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                ...
                <div className="masonry__item -no-ratio  web_design digital_design branding">
                    <div>
                        <div className="ratio ratio-48:50 hover-group">
                            <img className="absolute-full-center object-fit-cover z-1" src="/img/portfolio/cards/17.jpg" alt="image" />
                            <div className="px-10 py-10 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="d-flex justify-center items-center w-1/1 h-1/1 relative">
                                    <div className="bg-white absolute-full-center" />
                                    <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                ...
                <div className="masonry__item -no-ratio  web_design e_commerce branding">
                    <div>
                        <div className="ratio ratio-48:50 hover-group">
                            <img className="absolute-full-center object-fit-cover z-1" src="/img/portfolio/cards/8.jpg" alt="image" />
                            <div className="px-10 py-10 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="d-flex justify-center items-center w-1/1 h-1/1 relative">
                                    <div className="bg-white absolute-full-center" />
                                    <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                ...
                <div className="masonry__item -no-ratio  e_commerce">
                    <div>
                        <div className="ratio ratio-48:50 hover-group">
                            <img className="absolute-full-center object-fit-cover z-1" src="/img/portfolio/cards/16.jpg" alt="image" />
                            <div className="px-10 py-10 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="d-flex justify-center items-center w-1/1 h-1/1 relative">
                                    <div className="bg-white absolute-full-center" />
                                    <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                ...
                <div className="masonry__item -no-ratio  e_commerce digital_design">
                    <div>
                        <div className="ratio ratio-48:50 hover-group">
                            <img className="absolute-full-center object-fit-cover z-1" src="/img/portfolio/cards/18.jpg" alt="image" />
                            <div className="px-10 py-10 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="d-flex justify-center items-center w-1/1 h-1/1 relative">
                                    <div className="bg-white absolute-full-center" />
                                    <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                ...
                <div className="masonry__item -no-ratio  digital_design web_design branding">
                    <div>
                        <div className="ratio ratio-48:50 hover-group">
                            <img className="absolute-full-center object-fit-cover z-1" src="/img/portfolio/cards/9.jpg" alt="image" />
                            <div className="px-10 py-10 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="d-flex justify-center items-center w-1/1 h-1/1 relative">
                                    <div className="bg-white absolute-full-center" />
                                    <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                ...
                <div className="masonry__item -no-ratio  web_design digital_design branding">
                    <div>
                        <div className="ratio ratio-48:50 hover-group">
                            <img className="absolute-full-center object-fit-cover z-1" src="/img/portfolio/cards/20.jpg" alt="image" />
                            <div className="px-10 py-10 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="d-flex justify-center items-center w-1/1 h-1/1 relative">
                                    <div className="bg-white absolute-full-center" />
                                    <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
                ...
                <div className="masonry__item -no-ratio  web_design e_commerce branding">
                    <div>
                        <div className="ratio ratio-48:50 hover-group">
                            <img className="absolute-full-center object-fit-cover z-1" src="/img/portfolio/cards/6.jpg" alt="image" />
                            <div className="px-10 py-10 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="d-flex justify-center items-center w-1/1 h-1/1 relative">
                                    <div className="bg-white absolute-full-center" />
                                    <Link href="/portfolio/portfolio-single-1" className="absolute-full-center z-1" />
