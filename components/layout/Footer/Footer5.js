                ...
                <div className="footer__top relative z-2">
                    <div className="container">
                            ...
                            <div className="col-xl-5 col-lg-6">
                                <div>
                                    <p className="text-25 lh-17 text-white">
                                        To inquire for a new project or just to say hi, email us at <span className="fw-700">info@sassio.com</span>
                                    </p>
                                    <div className="y-gap-32 pt-48">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-white text-xl fw-600">hi@sassio.com</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row y-gap-20 justify-between items-center py-48 mt-60">
                            ...
                            <div className="col-sm-6">
                                <p className="text-white">© Copyright 2023. Sassio - NextJS template by AliThemes</p>
                            </div>
                        </div>
                    </div>
                </div>
