...
export default function Header9({ navColor, logo, scroll, navToggled, navHandle }) {
    return (
        <>
                            ...
                            <div className="d-flex">
                                <div className="header__logo d-flex items-center">
                                    <Link className="base-logo" href="/">
                                        <img className="base-logo-first" src="/img/general/logo.svg" alt="logo" />
                                        <img className="base-logo-second" src="/img/general/logo-dark.svg" alt="logo" />
                                    </Link>
