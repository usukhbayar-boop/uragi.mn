                        ...
                        <div className="col-auto">
                            <div className="header__right">
                                <div className="md:d-none">
                                    <Link href="/" className="button -sm -outline-light-dark sm:d-none">Нүүр хуудас</Link>
                                    <Link href="/register" className="button -sm -dark text-white ml-12">Бүртгүүлэх</Link>
                                </div>
