                        ...
                        <div className="container">
                            <div className="row justify-center text-center">
                                <div className="col-auto">
                                    ...
                                    <h2 className="sectionHeading__title">Таны бүртгэл амжилттай хийгдлээ!</h2>
                                        <p className="sectionHeading__text mt-20">Системд бүртгүүлсэн утасны дугаар, нууц үгээ ашиглан нэвтэрнэ үү!<br className="md:d-none" /></p>
                                    </div>
                                    <Link href="/login" className="button -md -accent text-white mt-40 md:mt-30">Нэвтрэх</Link>
                                </div>
                            </div>
                        </div>
                    </section>
