...
const PortfolioFilterHoverEffect = dynamic(() => import('@/components/portfolio/PortfolioFilterHoverEffect'), {
    ssr: false,
})
                        ...
                        <div className="container">
                            <div className="row justify-center text-center">
                                <div className="col-auto">
                                    ...
                                    <Link href="/contact/contact-1" className="button -md -accent text-white mt-40 md:mt-30">Get Started</Link>
                                </div>
                            </div>
                        </div>
                    </section>
