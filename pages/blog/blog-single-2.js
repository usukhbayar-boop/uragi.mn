                                ...
                                <div className="row justify-center text-center">
                                    <div className="col-xl-7 col-lg-9">
                                        <div className="d-flex items-center direction-column">
                                            <div>
                                                <h1 className="text-3xl sm:text-32 lh-16 fw-700 text-white">The best remote UX and UI design conferences to attend in 2022</h1>
                                            </div>
                                            <div className="row items-center y-gap-10 x-gap-10 text-white pt-20">
                                    ...
                                    <div className="row justify-center">
                                        ...
                                        <div className="col-12 pt-60 md:pt-40">
                                            <div className="row y-gap-32">
                                                ...
                                                <div className="col-12">
                                                    <img src="/img/blog/single-page/3.jpg" alt="image" className="initial-img rounded-8" />
                                                </div>
                                            </div>
                                        </div>
